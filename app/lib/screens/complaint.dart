...
class ComplaintPage extends StatefulWidget {
  final String acknowlwdgementNumber;
  ComplaintPage({Key? key, required this.acknowlwdgementNumber})
      : super(key: key);
  // PreferencesManager().ack=acknowlwdgementNumber
  @override
  State<ComplaintPage> createState() => _ComplaintPageState();
}
...
class _ComplaintPageState extends State<ComplaintPage> {
  ...
  // PreferencesManager().ack=widget.acknowlwdgementNumber,
  late SharedPreferences prefs;
  @override
  void initState() {
    // TODO: implement initState
  ...
  // while (retryCount < maxRetries) {
  //   try {
  //           var uri = Uri.parse('https://cyber-secure.onrender.com/v1/complainantId?acknowledgementNumber=${widget.acknowlwdgementNumber}');
  ...
  Future<void> _uploadImage(String? imagePath) async {
    ...
    final url = Uri.parse(
        'https://cyber-secure.onrender.com/v1/complainantId?acknowledgementNumber=${widget.acknowlwdgementNumber}');
    var request = http.MultipartRequest('POST', url);
    request.headers.addAll({
